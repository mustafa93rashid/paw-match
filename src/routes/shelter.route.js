...
const  {MAX_SHELTER_IMAGES,  shelterController} = require("../controllers/shelter.controller");
...
router.post(
  "/:id/images",
  [auth, role(["superadmin", "shelterEmployee"]), uploadArray("images", MAX_SHELTER_IMAGES)],
